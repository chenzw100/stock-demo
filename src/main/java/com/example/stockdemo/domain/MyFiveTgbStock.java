...
public class MyFiveTgbStock implements Comparable<MyFiveTgbStock>{
    ...
    public String toString(){
        ...
        sb.append(code).append(name).append("[出现:").append(showCount).append("最高:").append(getFiveHighRate()).append("最低:").append(getFiveLowRate()).
                append("七日:").append(hotSeven).append(",连板:").append(continuous).append("]竞价:").append(getTodayOpenRate()).append(",收盘:").append(getTodayCloseRate()).
