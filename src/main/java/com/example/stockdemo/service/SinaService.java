...
public class SinaService {
    ...
    public String weiboRequest(int page,StringBuilder sb){
        ...
        if(page==2){
            ...
            for(int i=0;i<10;i++){
                ...
                sb.append(stockObj.getString("title_sub")).append(":").append(stockObj.getString("itemid")).append(":").append(stockObj.getString("desc1")).append("<br>");
            }
        }else if(page==1) {
