...
public class HttpTookit {
    ...
    public static String sendHttpsPost(String url, Map<String,String> map,Map<String, String> headers){
        String  str = null;
        try {
            str = send(url, map, headers);
    ...
    public static String send(String url, Map<String,String> map,Map<String, String> headers) throws KeyManagementException, NoSuchAlgorithmException,  IOException {
